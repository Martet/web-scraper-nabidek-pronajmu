...
class ScraperEuroBydleni(ScraperBase):
    ...
    def build_response(self) -> requests.Response:
        request_data = {
            ...
            "sql[estate_area_min]": "",
            "sql[estate_area_max]": "",
            "sql[locality][locality][input]": "Ostrava, Česko",
            "sql[locality][locality][city]": "Ostrava, Česko",
            "sql[locality][locality][zip_code]": "",
            "sql[locality][locality][types]": "locality",
            "sql[locality][location][lat]": "49.8314621",
            "sql[locality][location][lng]": "18.2429304",
            "sql[locality][viewport][south]": "49.76838403302793",
            "sql[locality][viewport][west]": "18.144666661573588",
            "sql[locality][viewport][north]": "49.86982219338334",
            "sql[locality][viewport][east]": "18.332296551105863",
            "sql[poptavka][jmeno]": "",
